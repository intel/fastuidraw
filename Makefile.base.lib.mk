...
LIBRARY_debug_BASE_CFLAGS = $(LIBRARY_BASE_CFLAGS)
LIBRARY_release_BASE_CFLAGS = $(LIBRARY_BASE_CFLAGS) -DNDEBUG

LIBRARY_DEPENDS_CFLAGS = $(shell freetype-config --cflags)
...
LIBRARY_BUILD_debug_FLAGS = -g -DFASTUIDRAW_DEBUG
...
LIBRARY_$(1)_RESOURCE_DEPS = $$(patsubst %.cpp, $(1)/%.d, $(LIBRARY_STRING_RESOURCES_SRCS))
