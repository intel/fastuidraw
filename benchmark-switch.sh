...
RESULTS="results"
VERT_USE_SWITCH="false"
FRAG_USE_SWITCH="true"
BLEND_USE_SWITCH="true"
...
shader_options="uber_vert_use_switch $VERT_USE_SWITCH uber_frag_use_switch $FRAG_USE_SWITCH uber_blend_use_switch $BLEND_USE_SWITCH"
...
run_benchmark ./painter-cells-GL-release "width $WIDTH height $HEIGHT $shader_options" fastuidraw-results.txt
run_benchmark ./painter-cells-GLES-release "width $WIDTH height $HEIGHT $shader_options" fastuidraw-es-results.txt
