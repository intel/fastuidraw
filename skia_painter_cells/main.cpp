...
derived_init(int w, int h)
{
  m_table_params.m_wh = SkSize::Make(m_table_width.m_value, m_table_height.m_value);
  m_table_params.m_cell_count = SkISize::Make(m_num_cells_x.m_value, m_num_cells_y.m_value);
  ...
  m_table_params.m_min_speed = SkPoint::Make(m_min_x_velocity.m_value, m_min_y_velocity.m_value);
  m_table_params.m_max_speed = SkPoint::Make(m_max_x_velocity.m_value, m_max_y_velocity.m_value);
  ...
  m_cell_shared_state.m_path_paint.setStrokeWidth(SkScalar(m_init_stroke_width.m_value));
  m_cell_shared_state.m_path_paint.setAntiAlias(m_init_anti_alias_stroking.m_value);
