 ...
 * @{
 */
#define FASTUIDRAW_ENCODING_VALUE(a, b, c, d) \
  ...
  namespace CharacterEncoding
  {
    enum encoding_value_t:uint32_t
      {
         ...
         */
        apple_roman = FASTUIDRAW_ENCODING_VALUE('a', 'r', 'm', 'n'),
    };
    ...
    {
      uint32_t v;
      v = FASTUIDRAW_ENCODING_VALUE(a, b, c, d);
