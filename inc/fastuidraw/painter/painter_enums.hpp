 ...
 */
  ...
  namespace PainterEnums
  {
    ...
    enum cap_style
      {
        close_outlines, /*!< indicates to stroke with outlines of path closed */
        no_caps,        /*!< indicates to stroke with outlines of path are not closed and caps are not added */
        rounded_caps,   /*!< indicates to stroke with outlines of path are not closed and rounded caps are added */
        square_caps,    /*!< indicates to stroke with outlines of path are not closed and square caps are added */
