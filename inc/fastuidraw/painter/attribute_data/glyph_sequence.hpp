 ...
 */
  ...
  public:
    ...
    public:
       ...
       * value. The attribute data and index is generated by the
       * \ref  GlyphAttributePacker as returned by parents \ref
       * GlyphSequence::attribute_packer(). The data is constructed
       * lazily on demand.
