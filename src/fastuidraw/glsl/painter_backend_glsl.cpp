...
add_enums(fastuidraw::glsl::ShaderSource &src)
{
  ...
  */
  ...
  src
    ...
    .add_macro("fastuidraw_stroke_offset_cap_join_entering_join", StrokedPath::offset_cap_join_entering_join)
    .add_macro("fastuidraw_stroke_offset_cap_join_leaving_join", StrokedPath::offset_cap_join_leaving_join)
